...
```javascript
import { isAlmostEqual, isAlmostSameValue, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.3.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.3.0-deno/mod.js';
