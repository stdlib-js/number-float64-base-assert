...
```javascript
import { isSameValue } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.1.0-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.1.0-deno/mod.js';
