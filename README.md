...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { isAlmostEqual, isAlmostSameValue, isSameValue, isSameValueZero } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.3.1-esm/index.mjs';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-assert@v0.3.1-esm/index.mjs';
...
[@stdlib/number/float64/base/assert/is-almost-equal]: https://github.com/stdlib-js/number-float64-base-assert-is-almost-equal/tree/esm

[@stdlib/number/float64/base/assert/is-almost-same-value]: https://github.com/stdlib-js/number-float64-base-assert-is-almost-same-value/tree/esm
